...
<div class="team-container">
    ...
    <div class="col-xl-8 col-lg-7 col-md-7 col-sm-12">
            <h3 class="subpage-header">All drinks</h3>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-5" id="app">
                    <handle-mydrinks v-slot="{ addMydrinks, deleteMydrink, myallDrinks }">
                            <div class="action-heart" v-on:click="addMydrinks(<?php the_ID(); ?>, '<?php the_title(); ?>', '<?php the_permalink(); ?>', 
                                ...
                                <svg fill="#000000" width="48px" height="48px" viewBox="0 0 24 24" id="wine-glass" data-name="Line Color" xmlns="http://www.w3.org/2000/svg" class="icon line-color"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path id="primary" d="M12,14v7M9,21h6m-3-7h0A5,5,0,0,1,7,9V4A1,1,0,0,1,8,3h8a1,1,0,0,1,1,1V9A5,5,0,0,1,12,14Z" style="fill: none; stroke: #000000; stroke-linecap: round; stroke-linejoin: round; stroke-width:1.08;"></path></g></svg>
                            </div>                     
                            <span v-for="drink in myallDrinks">
                                <span v-if="drink.drink_id == <?php the_ID();?>">
                                    ...
                                    <svg fill="#000000" width="48px" height="48px" viewBox="0 0 24 24" id="wine-glass" data-name="Flat Color" xmlns="http://www.w3.org/2000/svg" class="icon flat-color"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path id="secondary" d="M12,22a1,1,0,0,1-1-1V14a1,1,0,0,1,2,0v7A1,1,0,0,1,12,22Z" style="fill: #a27b20;"></path><path id="primary" d="M15,22H9a1,1,0,0,1,0-2h6a1,1,0,0,1,0,2ZM16,2H8A2,2,0,0,0,6,4V9A6,6,0,0,0,18,9V4A2,2,0,0,0,16,2Z" style="fill: #a27b20;"></path></g></svg>
                                    </div>
                                </span>
                            </span>              
                    </handle-mydrinks>
        ...
        <div class="col-xl-4 col-lg-5 col-md-5 col-sm-12" id="app">
            ...
            <div style="margin: 50px;">
                ...
                <div class="recipe-tags">
                    <?php
                        $terms = get_terms_by_custom_post_type('drinks','post_tag');
                        foreach( $terms as $term ) {
                            $term_link = get_term_link( $term );
                    ?>
